import type { FindHttpResponsesRequest, FindHttpResponsesResponse, FormInput, GetCookieValueRequest, GetCookieValueResponse, GetHttpRequestByIdRequest, GetHttpRequestByIdResponse, GetHttpResponseBodyInfoRequest, JsonPrimitive, ListCookieNamesResponse, ListFoldersRequest, ListFoldersResponse, ListHttpRequestsRequest, ListHttpRequestsResponse, OpenWindowRequest, PromptFormRequest, PromptFormResponse, PromptTextRequest, PromptTextResponse, RenderGrpcRequestRequest, RenderGrpcRequestResponse, RenderHttpRequestRequest, RenderHttpRequestResponse, SendHttpRequestRequest, ShowToastRequest, TemplateRenderRequest, WorkspaceInfo } from "../bindings/gen_events.ts";
...
type AddDynamicMethod<T> = {
    dynamic?: (ctx: Context, args: CallPromptFormDynamicArgs) => MaybePromise<Partial<T> | null | undefined>;
};
type AddDynamic<T> = T extends any ? T extends {
    inputs?: FormInput[];
} ? Omit<T, "inputs"> & {
    inputs: Array<AddDynamic<FormInput>>;
    dynamic?: (ctx: Context, args: CallPromptFormDynamicArgs) => MaybePromise<Partial<Omit<T, "inputs"> & {
        inputs: Array<AddDynamic<FormInput>>;
    }> | null | undefined>;
